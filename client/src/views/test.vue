              ...
              <app-tabs class="w-11/12 lg:w-11/12 mx-auto mb-16" :tabList="tabListConstitutive">
                <template v-slot:tabPanel-1> 
                  <div  v-if = "selectedNode" class = "options1 custom-scrollbar">
                    <ul>
                      <li>
                        <b>Số nguyên phụ liệu gia công</b> <div class = "form-control">{{ selectedNode.name}}</div>  
                        <b>Số nguyên phụ liệu cấu thành</b> <div class = "form-control">{{selectedNode.title}} </div>
                      </li>
                    </ul>
                  </div>
                  <div v-else> 
