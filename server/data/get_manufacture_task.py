...
# dfManufactureTaskStatus = pd.DataFrame([item.__dict__ for item in dfManufactureTaskStatus]).drop(['_state'], axis=1)
...
#         WHERE MTD.deleted_at IS NULL AND MTS.deleted_at IS NULL
#         """)
