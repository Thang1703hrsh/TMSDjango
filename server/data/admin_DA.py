...
# SELECT 1 id, PD.code AS product_code, POD.order_id, POD.production_order_id , POI.code AS production_code , POD.quantity AS quantity_production_order,  PSO.quantity AS quantity_exported_production_order
